import { MomosUplode } from "./Js-src/Slices"
...
const Momos = () => {
    ...
    let { data, error, Loadding } = GetHook("http://localhost:4000/Momos")
    let Momos = useSelector((state) => state.Momos)
    let Card = useSelector((state) => { return (state.Card) })
    dispatch(MomosUplode(data))
            ...
            <div className="Straters_page">
                ...
                <div className="m-1 row  justify-content-center align-items-center">
                    <div id="carouselExampleControls" className="carousel slide col-lg-4" data-bs-ride="carousel">
                        <div className="carousel-inner">
                            <div className="carousel-item active">
                                <img src="../Images/Momos_Image/slid-1.avif" className="d-block w-100" alt="..." />
                            </div>
                            <div className="carousel-item">
                                <img src="../Images/Momos_Image/slid-2.jpg" className="d-block w-100" alt="..." />
                            </div>
                            <div className="carousel-item">
                                <img src="../Images/Momos_Image/slid-3.avif" className="d-block w-100" alt="..." />
                            </div>
                        </div>
                    ...
                    <div className="star-page col-12 col-lg-6">
                        <h3>Momos</h3>
                        <ul id='para' >
                            <li>Momos recipe is very common in my house and I keep preparing it with a wide variety of stuffings</li>
                            <li>I end up making these cute-looking dumplings with any leftover dry sabzi. </li>
                            <li> In addition, to make my life easier I do get a square-shaped momos sheet here in Asian supermarkets under the fridge section.</li>
                            <li>So basically my job is to stuff the veggies shape them as required and steam them till they get cooked.</li>
                        </ul>
                    </div>
